    ...
    <Layout>
      ...
      <section className="container mx-auto py-8">
        ...
        <p className="text-right mt-8">
          ปัจจุบันค่าเฟ่ และห้องสมุดของเรา อยู่ในช่วงการดูแลของ นายชนกชนม์ แผ่นคำ รหัสนักศึกษา 66070247
          ซึ่งมีบริการ หนังสือให้ได้อ่านนิดหน่อย ไม่มีรูปครับขอโทษ พี่โนว์ผมส่ง week 1 ไปแล้วแต่แก้ API KEY มันเลยบอกว่าส่ง Late อะครับตอนนี้ยังไม่ได้คะแนนเลย
        </p>
      </section>
